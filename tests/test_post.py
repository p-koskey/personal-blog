...
def setUp(self):
        ...
        self.new_post = Post(title='Review for movies',content='This movie is the best thing since sliced bread',user = self.user_Kaycee )
def tearDown(self):
        Post.query.delete()
        User.query.delete()

def test_check_instance_variables(self):
        self.assertEquals(self.new_post.title,'Review for movies')
